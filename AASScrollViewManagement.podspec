...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AASScrollViewManagement.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/demon.chen@icloud.com/AASScrollViewManagement'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'demon.chen@icloud.com' => 'demon.chen@earlydata.com' }
  s.source           = { :git => 'https://github.com/demon.chen@icloud.com/AASScrollViewManagement.git', :tag => s.version.to_s }
